...
export function NavItem({
  ...
  return (
    <ItemRoot
      ...
      {...ownerState}
      {...navItem.baseProps}
      className={clsx([navSectionClasses.item.root, className], {
 ...
 * @slot caption icon
 */
const ItemCaptionIcon = styled(Box, { shouldForwardProp })<StyledState>(({ theme }) => ({
 ...
 * @slot arrow
 */
const ItemArrow = styled(Box, { shouldForwardProp })<StyledState>(({ theme }) => ({
