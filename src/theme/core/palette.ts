...
import { createPaletteChannel, varAlpha } from '../../utils/style';
...
export const extendPalette: PaletteExtend = {
  shared: {
    inputUnderline: varAlpha(grey[500], opacity.inputUnderline),
    inputOutlined: varAlpha(grey[500], 0.2),
    paperOutlined: varAlpha(grey[500], 0.16),
    buttonOutlined: varAlpha(grey[500], 0.32),
  },
};
...
const basePalette: ColorSystemOptions['palette'] = {
  ...
  TableCell: { border: varAlpha(grey[500], 0.2) },
  ...extendPalette,
};
